...
var p = Math.pow,
  w = (s, e, t) =>
    e in s
      ? O(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (s[e] = t),
  C = (s, e) => {
    for (var t in e || (e = {})) B.call(e, t) && w(s, t, e[t]);
    if (v) for (var t of v(e)) N.call(e, t) && w(s, t, e[t]);
    return s;
  };
function y(s = 0, e = 0, t = 14) {
...
function x(s = { x: 0, y: 0 }, e, t, i) {
  return p(s.x - e, 2) + p(s.y - t, 2) <= p(i, 2);
}
function R(s = { x: 0, y: 0 }, e = {}, t = 1) {
...
function j(s = 0, e = 0) {
  let t = s + e,
    i;
  return t > 0 ? (i = t % 360) : (i = 360 + (t % 360)), i === 360 && (i = 0), i;
}
function W(s = 0, e = 0) {
  let t = 180 - e;
  return 180 - j(s, t);
}
function A(s = 0, e = 0, t = 1) {
  let i = ((s % 360) + e) % 360;
  return (i = H(i)), (i = (t === 1 ? 360 - i : 360 + i) % 360), (i *= t), s + i;
}
function c(s) {
...
function k(s = {}) {
  ...
  let e = () => {
    (s._mediaQueryList = window.matchMedia(
      `(resolution: ${window.devicePixelRatio}dppx)`
    )),
      s._mediaQueryList.addEventListener(
        "change",
        s._handler_onDevicePixelRatioChange,
        { once: !0 }
      );
  };
  (s._handler_onDevicePixelRatioChange = () => {
...
function V(s = {}) {
  ...
  "PointerEvent" in window
    ...
    : (e.removeEventListener("touchstart", s._handler_onTouchStart),
      ...
      e.removeEventListener("mousemove", s._handler_onMouseMoveRefreshCursor)),
    window.removeEventListener("resize", s._handler_onResize),
    s._mediaQueryList.removeEventListener(
      "change",
      s._handler_onDevicePixelRatioChange
    );
}
function q(s = {}) {
  ...
  (s._handler_onPointerMoveRefreshCursor = (t = {}) => {
    ...
    (s._isCursorOverWheel = s.wheelHitTest(i)), s.refreshCursor();
  }),
    ...
    (s._handler_onTouchStart = (t = {}) => {
      let i = { x: t.targetTouches[0].clientX, y: t.targetTouches[0].clientY };
      if (!s.isInteractive || !s.wheelHitTest(i)) return;
      t.preventDefault(),
        s.dragStart(i),
...
var L = class {
  constructor(e, t = {}) {
    ...
    if (!c(t) && t !== null) throw new Error("props must be an Object or null");
    this._wheel = e;
  ...
  getRandomAngle() {
    return y(this.getStartAngle(), this.getEndAngle());
  }
};
var D = class {
  constructor(e, t = {}) {
  ...
  resize() {
    ...
    (this._size = Math.max(r.w * n, r.h * n)),
      ...
      (this.itemLabelFontSize = this.itemLabelFontSizeMax * (this._size / 500)),
      (this.labelMaxWidth =
    ...
    for (let a of this._items)
      this.itemLabelFontSize = Math.min(
        ...
        I(a.label, this.itemLabelFont, this.labelMaxWidth, this._context)
      );
    this.refresh();
  }
  draw(e = 0) {
    ...
    for (let [r, n] of t.entries()) {
      ...
      (e.fillStyle =
        (i = a.backgroundColor) != null
          ? i
          : this._itemBackgroundColors[r % this._itemBackgroundColors.length]),
        e.fill(a.path);
    }
  }
  drawItemImages(e, t = []) {
  ...
  spinToItem(e = 0, t = 0, i = !0, r = 1, n = 1, a = null) {
    ...
    let h = i ? this.items[e].getCenterAngle() : this.items[e].getRandomAngle(),
  ...
  animate(e, t, i) {
    (this._spinToStartRotation = this.rotation),
      ...
      (this._spinToEasingFunction = i || P),
      this.refresh();
  }
  stop() {
    (this._spinToTimeEnd = null),
  ...
  wheelHitTest(e = { x: 0, y: 0 }) {
    let t = R(e, this.canvas, this.getActualPixelRatio());
    return x(t, this._center.x, this._center.y, this._actualRadius);
  }
  refreshCursor() {
  ...
  getAngleFromCenter(e = { x: 0, y: 0 }) {
    return (E(this._center.x, this._center.y, e.x, e.y) + 90) % 360;
  }
  getCurrentIndex() {
  ...
  refreshCurrentIndex(e = []) {
    ...
    for (let [t, i] of e.entries())
      if (!!M(this._pointerAngle, i.start % 360, i.end % 360)) {
  ...
  get image() {
    var e, t;
    return (t = (e = this._image) == null ? void 0 : e.src) != null ? t : null;
  }
  set image(e) {
    (this._image = l({
      val: e,
  ...
  raiseEvent_onCurrentIndexChange(e = {}) {
    ...
    (t = this.onCurrentIndexChange) == null ||
      t.call(
        this,
        C({ type: "currentIndexChange", currentIndex: this._currentIndex }, e)
      );
  }
  raiseEvent_onRest(e = {}) {
    var t;
